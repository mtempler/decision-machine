...
| T-305 | Agent | No duplicate downloads | Wait for second agent poll after file downloaded | File not re-downloaded — deleted from S3 on first download so it no longer exists in the bucket | □ |
| T-306 | Agent | Downloads error files | Trigger Lambda error · Wait ≤60s | ERROR_*.txt appears in watch_path/errors/ | □ |
| T-306b | Agent | Delete retry on failure | Simulate s3:DeleteObject permission failure after download · Check console | Warning logged with attempt count; file remains safely in watch_path/; agent continues normally after 3 attempts | □ |
...
| T-418 | Mgmt | Deleted file does not reappear after S3 agent poll | Delete a file from dashboard · Wait 60s for agent poll · Refresh dashboard | File does not reappear — deleted from S3 on original download so agent has nothing to re-download | □ |
| T-419 | Mgmt | Archived file does not reappear after S3 agent poll | Archive all files · Wait 60s for agent poll · Refresh dashboard | Files remain archived — deleted from S3 on original download so agent has nothing to re-download | □ |
